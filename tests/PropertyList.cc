...
BOOST_AUTO_TEST_CASE(getScalarThrow) { /* parasoft-suppress LsstDm-3-1 LsstDm-3-4a LsstDm-5-25 LsstDm-4-6 "Boost test harness macros" */
    ...
    BOOST_CHECK_THROW(pl.get<bool>("short"), lsst::pex::exceptions::TypeError);
    BOOST_CHECK_THROW(pl.get<bool>("int"), lsst::pex::exceptions::TypeError);
    BOOST_CHECK_THROW(pl.get<short>("int"), lsst::pex::exceptions::TypeError);
    BOOST_CHECK_THROW(pl.get<int>("short"), lsst::pex::exceptions::TypeError);
    BOOST_CHECK_THROW(pl.get<int>("bool"), lsst::pex::exceptions::TypeError);
    BOOST_CHECK_THROW(pl.get<unsigned int>("int"), lsst::pex::exceptions::TypeError);
    BOOST_CHECK_THROW(pl.get<double>("float"), lsst::pex::exceptions::TypeError);
    BOOST_CHECK_THROW(pl.get<float>("double"), lsst::pex::exceptions::TypeError);
    BOOST_CHECK_THROW(pl.get<std::string>("int"), lsst::pex::exceptions::TypeError);
}
...
BOOST_AUTO_TEST_CASE(getAs) { /* parasoft-suppress LsstDm-3-1 LsstDm-3-4a LsstDm-5-25 LsstDm-4-6 "Boost test harness macros" */
    ...
    BOOST_CHECK_THROW(pl.getAsBool("char"), lsst::pex::exceptions::TypeError);
    ...
    BOOST_CHECK_THROW(pl.getAsInt("int64_t"), lsst::pex::exceptions::TypeError);
    ...
    BOOST_CHECK_THROW(pl.getAsInt64("float"), lsst::pex::exceptions::TypeError);
    ...
    BOOST_CHECK_THROW(pl.getAsDouble("char*"), lsst::pex::exceptions::TypeError);
    BOOST_CHECK_THROW(pl.getAsString("char"), lsst::pex::exceptions::TypeError);
    ...
    BOOST_CHECK_THROW(pl.getAsString("int"), lsst::pex::exceptions::TypeError);
...
BOOST_AUTO_TEST_CASE(combineThrow) { /* parasoft-suppress LsstDm-3-1 LsstDm-3-4a LsstDm-5-25 LsstDm-4-6 "Boost test harness macros" */
    ...
    BOOST_CHECK_THROW(pl.combine(psp), lsst::pex::exceptions::TypeError);
}
