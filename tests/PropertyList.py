...
class PropertyListTestCase(unittest.TestCase):
    ...
    def testGetScalarThrow(self):
        ...
        apl.setDouble("double", 2.718281828459045)
        apl.setString("string", "bar")
        self.assertRaises(pexExcept.Exception, apl.get, "foo")
        self.assertRaises(pexExcept.Exception, apl.getBool, "short")
        self.assertRaises(pexExcept.Exception, apl.getBool, "int")
        self.assertRaises(pexExcept.Exception, apl.getShort, "int")
        self.assertRaises(pexExcept.Exception, apl.getInt, "short")
        self.assertRaises(pexExcept.Exception, apl.getInt, "bool")
        self.assertRaises(pexExcept.Exception, apl.getDouble, "float")
        self.assertRaises(pexExcept.Exception, apl.getFloat, "double")
        self.assertRaises(pexExcept.Exception, apl.getString, "int")
