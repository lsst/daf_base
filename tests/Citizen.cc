...
BOOST_AUTO_TEST_SUITE(CitizenSuite) /* parasoft-suppress LsstDm-3-2a LsstDm-3-2a LsstDm-3-6a LsstDm-4-6 "Boost test harness macros" */
...
BOOST_AUTO_TEST_CASE(all) { /* parasoft-suppress LsstDm-3-1 LsstDm-3-4a LsstDm-5-25 LsstDm-4-6 "Boost test harness macros" */
    Shoe x;
