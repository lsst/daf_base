...
PYBIND11_PLUGIN(propertySet) {
    ...
    py::class_<std::type_info>(mod, "TypeInfo")
        .def("__eq__", [](std::type_info const & self, std::type_info const & other) { return self == other; })
        .def("__ne__", [](std::type_info const & self, std::type_info const & other) { return self != other; });
