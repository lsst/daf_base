...
template <typename T, typename C> void declareAccessors(C &cls, std::string const& name) {
...
PYBIND11_PLUGIN(propertyList) {
    ...
    cls.def("deepCopy", [](PropertyList const & self){return std::static_pointer_cast<PropertySet>(self.deepCopy());});
    ...
    cls.def("__getstate__", [](PropertyList const & self) -> py::object {
        auto module = py::reinterpret_borrow<py::object>(PyImport_ImportModule("lsst.daf.base.propertyContainer"));
        if (!module.ptr()) {
            ...
            if (!func.ptr()) {
                ...
                auto result = py::reinterpret_steal<py::object>(PyObject_CallFunctionObjArgs(func.ptr(), pySelf.ptr(), NULL));
                return result;
            }
        }
        return py::none{};
    ...
    cls.def("__setstate__", [](PropertyList & self, py::object state) {
        ...
        if (!module.ptr()) {
            ...
            if (!func.ptr()) {
                ...
                auto pySelf = py::cast(self);
                auto result = py::reinterpret_steal<py::object>(PyObject_CallFunctionObjArgs(func.ptr(), pySelf.ptr(), state.ptr(), NULL));
            }
        }
    });
